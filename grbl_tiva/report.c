...
#include "grbl.h"
// hack to provide compatible function
#define PSTR	""+
...
void report_alarm_message(uint8_t alarm_code)
{
  ...
  report_util_line_feed();
  delay_ms(50); // Force delay to ensure message clears serial write buffer.
}
...
{
  int idx;
  int current_position[N_AXIS]; // Copy current state of the system position variable
