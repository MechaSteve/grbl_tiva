...
#ifdef DEFAULTS_HANOI
  // 2 axis vertical core XY gantry. Implemented as a crossbot configuration
  // 2 small NEMA 17 stepper motors with 0.4A per coil 24V50W Allen-Bradley power supply
#include "defaults/defaults_hanoibot.h"
#endif
